    ...
    <section className="relative overflow-hidden pt-14 pb-10 sm:pt-20 sm:pb-14">
      <div className="relative mx-auto max-w-3xl px-5 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-[15px] leading-relaxed text-ink-muted sm:text-base sm:leading-7">
          Rehearse a real back-and-forth with an AI interviewer — no
          pre-recorded video answers. In 15–20 minutes you get a 0–100
          match-fit score with per-area feedback, plus the full video &amp;
          transcript.
        </p>
